# Dynamic PDF Maker Integration in Angular Using PDFmaker
...
# 7 Easy Steps Follow and Integrate Dynamic PDF Content Generator.

## Step-1 => `new new projectname`
## Step-2 => `npm install pdfmake --save`
## Step-3 => angular.json paste it
		"scripts": [
              "node_modules/pdfmake/build/pdfmake.min.js",
              "node_modules/pdfmake/build/vfs_fonts.js"
            ]
## Step-4 =>   app.modules.ts
            import { FormsModule } from "@angular/forms"; 
     		imports: [..,FormsModule]

## Step-5 =>   app.compoenet.ts

			`declare var pdfMake: any;

			title:string = "Angular is a platform for building mobile and desktop web applications.";
...
## Step-7 =>  app.compoenets.html
			<input type="text" [(ngModel)]="title" class="input-css">
			<button (click)="generatePdf()">Generate</button>
			<br>
			<div class="pdf-veiw">
			  <img src="assets/download.png" alt="" width="60" height="60">
			  <p>{{title}}</p>
			</div>			